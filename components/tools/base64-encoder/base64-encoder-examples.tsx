...
interface Base64EncoderExamplesProps {
  lang: LanguageType;
  onLoadExample: (data: string) => void;
}

export function Base64EncoderExamples({
  lang,
  onLoadExample,
}: Base64EncoderExamplesProps) {
...
interface Base64EncoderExampleCardProps {
  example: ExampleData;
  onLoadExample: (data: string) => void;
  t: (key: string) => string;
}

function Base64EncoderExampleCard({
  example,
  onLoadExample,
  t,
}: Base64EncoderExampleCardProps) {
