      ...
      <motion.section className="mb-12" variants={itemVariants}>
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold">What is a URL Encoder?</h2>
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                A URL encoder is a tool that converts special characters into a format
                that can be safely transmitted over the internet. It replaces unsafe
                characters with "%" followed by two hexadecimal digits, ensuring URLs
                remain valid and functional across different systems and browsers.
              </p>
              <p>
                This encoding is essential for web development, API integration, and
                any scenario where you need to include special characters in URLs
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>Encode and decode URLs with special characters</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
              ...
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>Support for both encoding and decoding operations</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>Batch processing for multiple URLs</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>One-click copying of encoded results</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>Web development and HTML form submissions</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>API parameter encoding and URL construction</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>Social media sharing and link generation</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>Email link encoding and HTML email campaigns</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>Database query string preparation</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <div>
                ...
                <p>Encoding product names and categories with spaces and special characters to create SEO-friendly URLs for better search engine visibility.</p>
              </div>
              <div>
                <strong className="text-foreground">Social Media Integration:</strong>
                <p>Encoding user-generated content and hashtags to ensure they work correctly when shared across different social media platforms.</p>
              </div>
              <div>
                <strong className="text-foreground">API Development:</strong>
                <p>Encoding query parameters and path segments that contain special characters, ensuring API endpoints remain accessible and secure.</p>
              </div>
              <div>
                <strong className="text-foreground">Internationalization:</strong>
                <p>Encoding non-ASCII characters in URLs to support multiple languages and ensure proper display across different browsers and regions.</p>
              </div>
            </div>
          </div>
        </div>
