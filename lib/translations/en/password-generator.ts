export const passwordGenerator = {
  ...
  "passwordGenerator.presetsDesc": "Pre-configured password settings for different security levels. Click \"Quick Run\" to generate with preset settings:",
  ...
  // SEO Content
  "passwordGenerator.seo.title": "Why Use a Password Generator? How Does it Work?",
  "passwordGenerator.seo.desc": "Strong, unique passwords are essential for security. This tool uses <strong className=\"text-foreground\">cryptographically secure</strong> random number generation via the Web Crypto API (crypto.getRandomValues) to create passwords that are virtually impossible to guess or crack through brute force. The implementation supports both random character generation and passphrase-based methods.",
  
  "passwordGenerator.tech.title": "Technical Implementation",
  "passwordGenerator.tech.randomTitle": "Random Password Generation:",
  "passwordGenerator.tech.randomList1": "Uses crypto.getRandomValues() for cryptographically secure randomness",
  "passwordGenerator.tech.randomList2": "Builds character pools dynamically based on user preferences",
  "passwordGenerator.tech.randomList3": "Optional ambiguous character exclusion (0, O, 1, l, I for better readability)",
  "passwordGenerator.tech.randomList4": "Uniform distribution ensures each character position is equally likely",
  "passwordGenerator.tech.randomList5": "Supports length from 4 to 64 characters with various character types",
  
  "passwordGenerator.tech.passphraseTitle": "Passphrase Generation:",
  "passwordGenerator.tech.passphraseList1": "Dictionary-based selection from 100+ common English words",
  "passwordGenerator.tech.passphraseList2": "Each word adds approximately 6.6 bits of entropy",
  "passwordGenerator.tech.passphraseList3": "Optional capitalization and number/symbol addition",
  "passwordGenerator.tech.passphraseList4": "Customizable separators (hyphen, underscore, space, etc.)",
  "passwordGenerator.tech.passphraseList5": "Word count range: 3-8 words for different security levels",

  "passwordGenerator.features.title": "Key Features",
  "passwordGenerator.feature.secure.title": "Cryptographically Secure",
  "passwordGenerator.feature.secure.desc": "Uses Web Crypto API for true randomness",
  ...
  "passwordGenerator.feature.passphrase.desc": "Easy-to-remember word combinations",
  ...
  "passwordGenerator.bestPractices.item1": "Use a unique password for every account",
  "passwordGenerator.bestPractices.boundary1": "✅ Critical - Prevents credential stuffing attacks across multiple services",
  "passwordGenerator.bestPractices.item2": "Make passwords at least 12-16 characters long",
  "passwordGenerator.bestPractices.boundary2": "✅ Recommended - 16+ characters for high-value accounts (banking, email)",
  "passwordGenerator.bestPractices.item3": "Include uppercase, lowercase, numbers, and symbols",
  "passwordGenerator.bestPractices.boundary3": "✅ Important - Increases entropy and resists dictionary attacks",
  "passwordGenerator.bestPractices.item4": "Store passwords in a secure password manager",
  "passwordGenerator.bestPractices.boundary4": "✅ Essential - Never reuse passwords or write them down unsecured",
  "passwordGenerator.bestPractices.item5": "Enable two-factor authentication when available",
  "passwordGenerator.bestPractices.boundary5": "✅ Strongly recommended - Adds critical second layer of security",

  "passwordGenerator.faq.title": "Frequently Asked Questions",
  "passwordGenerator.faq.q1": "Is this password generator secure?",
  "passwordGenerator.faq.a1": "Yes! We use the Web Crypto API (crypto.getRandomValues) which provides cryptographically secure random numbers. All generation happens locally in your browser.",
  "passwordGenerator.faq.q2": "Are my passwords stored anywhere?",
  "passwordGenerator.faq.a2": "No. Generated passwords exist only in your browser and are never sent to any server. Once you close the page, they're gone unless you save them.",
  "passwordGenerator.faq.q3": "What makes a strong password?",
  "passwordGenerator.faq.a3": "A strong password is long (16+ characters), uses a mix of character types, is unique to each account, and is random (not based on dictionary words or personal info).",
};
